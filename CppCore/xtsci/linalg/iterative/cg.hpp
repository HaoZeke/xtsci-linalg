...
void conjugate_gradient(const xt::xexpression<E1>& mat_expr,
                        const xt::xexpression<E2>& rhs_expr,
                        xt::xexpression<E3>& x_expr,
                        const Preconditioner& precond,
                        int& iterations,
                        typename E3::value_type& final_error)
{
    ...
    RealScalar threshold = std::max(tol * tol * rhsNorm2, std::numeric_limits<RealScalar>::min());
